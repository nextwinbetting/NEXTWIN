...
const NextWinLogo: React.FC<{ className?: string }> = ({ className }) => {
    return (
        <div className={`flex items-center gap-3 ${className}`}>
            <svg viewBox="0 0 38 38" className="h-full w-auto" fill="none" xmlns="http://www.w.w3.org/2000/svg">
                <defs>
            ...
            <span className="text-3xl font-bold tracking-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-brand">Win</span>
            </span>
        </div>
    );
};
