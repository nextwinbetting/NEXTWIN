    ...
    return (
        <div className="glass-premium p-10 flex flex-col h-full group relative overflow-hidden transition-all duration-500 border-white/5 hover:border-brand-orange/40 rounded-[3rem]">
            ...
            <div className="flex items-center justify-between mb-12 relative z-10">
                <span className="text-[10px] font-black text-white/50 uppercase tracking-[0.4em] italic">{prediction.date} • {prediction.time}</span>
            ...
            <div className="mb-12 relative z-10">
                <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.5em] mb-4 truncate italic">{prediction.competition}</p>
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6 mb-12 relative z-10">
                <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.4em] mb-2 italic">Scénario Engine</p>
            ...
            <div className="mt-auto flex items-end justify-between relative z-10">
                <div className="flex flex-col">
                    <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.4em] italic mb-2">FIABILITÉ IA</span>
                    <span className={`text-5xl font-sans font-black italic tracking-tighter ${isVeryHigh ? 'text-white' : 'text-white/60'}`}>{prob}%</span>
                </div>
